...
| Compose Compiler Plugin | 2.0.0 | Matches KGP version | Must match KGP major.minor (e.g., KGP 2.3.0 uses compose compiler 2.3.x) |
...
- Does **not** support AGP 9.0 as of 2026.1.
