...
| `shared/src@wasmJs/` (web) | `./kotlin build -m webApp` | `./kotlin test -m shared -p wasmJs` | Links only; **no browser bundle / run / deploy** in Toolchain 0.11.0 (see TOOLCHAIN_FEEDBACK.md §12) |
